...
from dataset.cub import CUBZeroShot
from dataset.nabirds import NABirds
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="train",
        choices=["train", "val", "test", "trainval", "test_seen", "test_unseen"],
    )
    ...
    if args.arch == "stylegan2":
        ...
        from model.stylegan2_pytorch.swagan import Generator, Discriminator
    ...
    if args.dataset == "cub":
        ...
        dataset = CUBZeroShot("data", split=args.split, transform=transform)
        ...
        dataset = NABirds("data", split=args.split, transform=transform)
